...
score = clip(base + lifecycle_adj,  0.0,  1.0)
    ...
    <table class="data-table">
      ...
      <tbody>
        <tr><td>1</td><td>PROD_CS_01</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>2</td><td>PROD_CS_02</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>3</td><td>PROD_CS_03</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>4</td><td>PROD_CS_04</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>5</td><td>PROD_CS_05</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>6</td><td>PROD_CS_06</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>7</td><td>PROD_CS_07</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>8</td><td>PROD_CS_08</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>9</td><td>PROD_CS_09</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>10</td><td>PROD_CS_10</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>11</td><td>PROD_CS_11</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>12</td><td>PROD_CS_12</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>13</td><td>PROD_CS_13</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>14</td><td>PROD_CS_NEW</td><td><span class="tag tag-cs">CS</span></td><td><span class="tag tag-new">新発売品</span></td></tr>
        <tr><td>15</td><td>PROD_PS_01</td><td><span class="tag tag-ps">PS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>16</td><td>PROD_PS_02</td><td><span class="tag tag-ps">PS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>17</td><td>PROD_PS_03</td><td><span class="tag tag-ps">PS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>18</td><td>PROD_PS_04</td><td><span class="tag tag-ps">PS</span></td><td><span class="tag tag-existing">既存品</span></td></tr>
        <tr><td>19</td><td>PROD_PS_NEW</td><td><span class="tag tag-ps">PS</span></td><td><span class="tag tag-new">新発売品</span></td></tr>
      </tbody>
    </table>
  </div>
</div><!-- /overview -->
...
<div class="section-card" id="step1">
  <div class="section-header">
    ...
    <div>
      ...
      <div class="section-subtitle">マインドスケープ区分に基づくセグメント別医師数の集計</div>
    </div>
  </div>
  <div class="section-body">
    <p>
      製品ごとに定義された <strong>マインドスケープ（Mindscape）</strong> セグメントの訪問優先度スコアと、
      セグメント別医師数を掛け合わせ、当該製品の実質的なターゲット医師数を算出します。
    </p>
    <h3>主要式</h3>
    <div class="formula-box">
      <div class="formula-label">STEP 1 — ターゲット医師数</div>
target_drs(p) = Σ<sub>s</sub> [ mindscape_weight(p, s) × dr_count(p, s) ]
    </div>
    <h3>マインドスケープ区分</h3>
    <table class="data-table">
      <thead>
      ...
      <tbody>
        <tr><td><strong>Champion</strong></td><td>積極的に使用・推奨する医師</td><td><span class="num-badge">1.0</span></td></tr>
        <tr><td><strong>Loyalist</strong></td><td>安定使用層</td><td><span class="num-badge">0.8</span></td></tr>
        <tr><td><strong>Follower</strong></td><td>競合品も使用するが自社品も使う</td><td><span class="num-badge">0.6</span></td></tr>
        <tr><td><strong>Fence Sitter</strong></td><td>未決定・態度保留層</td><td><span class="num-badge">0.4</span></td></tr>
        <tr><td><strong>Competitor</strong></td><td>競合品メイン使用層</td><td><span class="num-badge">0.2</span></td></tr>
        <tr><td><strong>Non-user</strong></td><td>未使用・接触不要</td><td><span class="num-badge">0.0</span></td></tr>
      </tbody>
    </table>
    <div class="info-box blue">
      <span class="info-icon">ℹ️</span>
      <span>
        マインドスケープCSVが存在しない場合は、<strong>フォールバック式</strong>を使用：
        <code>target_drs(p) = total_dr_universe(p) × default_targeting_rate(p)</code>
      </span>
    </div>
  </div>
</div><!-- /step1 -->
